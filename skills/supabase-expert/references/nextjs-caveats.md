...
| Middleware | `createServerClient` | `request.cookies` | Auth guards |
...
Ensure middleware returns `supabaseResponse`:
...
- [ ] Middleware calls `getUser()` and returns `supabaseResponse`
